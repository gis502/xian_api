...
/**
    ...
    */
@Data
@TableName(value = "xian_disaster_landslide")
public class XianDisasterLandslide {
    /**
     * 灾害ID
     */
     ...
     * 滑坡体积
     */
    @TableField(value = "slide_volume")
    private String slideVolume;
